...
function registerFetch(token) {
    ...
    const validations = [
        ...
        },
        {
            ...
            message:
                "Login must start with a letter, contain only Latin letters, numbers, and underscores, and be at least 2 characters long",
        },
        {
    ...
    fetch("/api/register", {
        ...
        .then((response) => {
            ...
            document.getElementById(
                "info-message"
            ).innerHTML = `<p>We've sent a confirmation email to ${email}.</p><p>Please</p><p>1. check your inbox (and spam/junk folder)</p><p>2. Click the "Confirm Email" button in the email.</p>`;
