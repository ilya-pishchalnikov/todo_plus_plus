class AppEvent {
    ...
    async resendEvents() {
        ...
        events.forEach((event) => {
            this.eventSocket.send(event.data);
        });
    ...
    connect() {
        if (!("WebSocket" in window)) {
            alert(
                "Your browser does not support WebSocket. This site will not work correctly. Please consider updating your browser or using a different browser that supports WebSocket."
            );
            return;
        }
